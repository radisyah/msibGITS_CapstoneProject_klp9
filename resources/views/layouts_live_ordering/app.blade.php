...
<html lang="en">
 ...
 .table-scrollable {
  overflow-y: scroll;
  height: 650px;
  scrollbar-width: thin; /* Atur lebar scrollbar */
  scrollbar-color: transparent transparent transparent #888; /* Atur warna scrollbar */
...
<body class="hold-transition layout-top-nav">
    ...
    {{-- <!-- Nav -->
    @include('layouts_live_ordering.navbar')
    <!-- End of Nav --> --}}

     
    @yield('contents_live_ordering')
      

    @include('layouts_live_ordering.footer')
