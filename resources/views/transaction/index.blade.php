                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class="row">
                                @foreach ($products_makanan as $value)
                                    <div class="col-md-3">
                                        <form
                                            action="{{ route('add_cart',['id_product'=>$value->id_product, 'nomor_meja'=>$nomor_meja])}}"
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <button type="submit" href="https://www.copycat.dev/"
                                                        class="btn btn-primary btn-block">
                                                        <i class="text-center fas fa-cart-plus fa-lg mr-2"></i>
                                                        Tambah
                                                    </button>
                                                </div>
                                            </div>
